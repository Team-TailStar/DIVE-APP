...
class AqCardTheme extends ThemeExtension<AqCardTheme> {
  ...
  AqCardTheme lerp(ThemeExtension<AqCardTheme>? other, double t) {
    ...
    return AqCardTheme(
      ...
      cardBg: _c(cardBg, other.cardBg),
      cardBorder: _c(cardBorder, other.cardBorder),
      tileBg: _c(tileBg, other.tileBg),
      tileBorder: _c(tileBorder, other.tileBorder),
      chipBg: _c(chipBg, other.chipBg),
      chipFg: _c(chipFg, other.chipFg),
      iconColor: _c(iconColor, other.iconColor),
      chipGoodBg: _c(chipGoodBg, other.chipGoodBg),
      chipGoodFg: _c(chipGoodFg, other.chipGoodFg),
      chipModerateBg: _c(chipModerateBg, other.chipModerateBg),
      chipModerateFg: _c(chipModerateFg, other.chipModerateFg),
      chipBadBg: _c(chipBadBg, other.chipBadBg),
      chipBadFg: _c(chipBadFg, other.chipBadFg),
      chipVeryBadBg: _c(chipVeryBadBg, other.chipVeryBadBg),
      chipVeryBadFg: _c(chipVeryBadFg, other.chipVeryBadFg),
